...
# Adapted to Piper PA-38 by Adrian Fernandez (awall86)
...
var init_dlg = gui.Dialog.new("/sim/gui/dialogs/acconfig/init/dialog", "Aircraft/pa38/AircraftConfig/init.xml");
var update_dlg = gui.Dialog.new("/sim/gui/dialogs/acconfig/update/dialog", "Aircraft/pa38/AircraftConfig/update.xml");
var updated_dlg = gui.Dialog.new("/sim/gui/dialogs/acconfig/updated/dialog", "Aircraft/pa38/AircraftConfig/updated.xml");

spinning.start();
init_dlg.open();
http.load("https://raw.githubusercontent.com/awall086/pa38/master/revision.txt").done(func(r) setprop("/systems/acconfig/new-revision", r.response));
...
setlistener("/sim/signals/fdm-initialized", func {
	...
	if (getprop("/systems/acconfig/out-of-date") == 1) {
		update_dlg.open();
		print("System: Your Cessna 170b is out of date!");
	} 
	spinning.stop();
});

var readSettings = func {
	io.read_properties(getprop("/sim/fg-home") ~ "/Export/pa38-config.xml", "/systems/acconfig/options");
...
var writeSettings = func {
	...
	io.write_properties(getprop("/sim/fg-home") ~ "/Export/pa38-config.xml", "/systems/acconfig/options");
}
